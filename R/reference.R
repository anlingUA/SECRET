#' generate cell type reference
#'
#' @param input_data input single cell data
#' @param ct_var what variable name for cell type
#' @param sample_var what variable name for sample
#'
#' @return gene by cell type expression
#' @export
#'
